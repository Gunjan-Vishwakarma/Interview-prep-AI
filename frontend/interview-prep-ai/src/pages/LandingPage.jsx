  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF]  relative">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10 lg:px-16">
          {/* Header  */}
          <header className="flex justify-between items-center mb-16 ">
            ...
            {user ? (
              ...
              <button
                className="bg-linear-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:from-black hover:to-black border border-white transition-colors cursor-pointer"
        ...
        <div>
          <section className="flex items-center justify-center -mt-36">
            <img
              src={HERO_IMG}
              alt="Hero Image"
              className="w-[80vw] rounded-lg border border-yellow-300"
            />
          </section>
        </div>
